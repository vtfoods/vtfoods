...
export const useSections = () => {
  ...
  return useMemo(() => {
    return [
      {
        subheader: t(tokens.nav.development),
        items: [
          {
            title: t(tokens.nav.developmentExample),
            icon: (
          ...
          },
          {
            ...
            items: [
              {
                title: t(tokens.nav.saasAplication),
                path: paths.saasAplication
              },
              {
                title: t(tokens.nav.mobileApp),
                path: paths.mobileApp
              },
              {
                title: t(tokens.nav.webApp),
                path: paths.webApp
              },
              {
                title: t(tokens.nav.fullStack),
                path: paths.fullStack
              },
              {
                title: t(tokens.nav.serverLess),
                path: paths.serverLess
              },
              // {
              //   title: t(tokens.nav.apiDevelopment),
              //   path: paths.apiDevelopment
              // },
              {
                title: t(tokens.nav.devlopServices),
                path: paths.devlopServices
              },
              {
                title: t(tokens.nav.uiux),
                path: paths.uiux
              },
                 {
                title: t(tokens.nav.offShore),
                path: paths.offShore
              },
            ]
          },
