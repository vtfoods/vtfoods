export const weAreData = [
    "HVG Infotech Private Limited, established in 2020 and headquartered in Surat, Gujarat, is a distinguished software solutions provider specializing in mobile app development, web development, and offshore development teams. With a dedicated team of over 20 professionals, including skilled developers, UI/UX designers, and technology experts, we are committed to delivering top-notch, customized IT services.",
    ...
    "At HVG Infotech Private Limited, our mission is to enhance user experiences, establish market authority, and elevate brand presence through innovative and feature-rich solutions. We are passionate about leveraging our industry expertise to align closely with client goals and deliver exceptional results that drive business success.",
  ];
 ...
 export const aboutItems = [
  ...
  export const coreData = [
    ...
    {
      title: "Teamwork",
      desc: " Collaboration is key to our success. We value diverse perspectives and work together seamlessly to achieve common goals.",
      img: "/assets/core4.png",
    },
