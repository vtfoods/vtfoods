...
const ServerlessData = {
  ...
  desc: [
    "With over 5 years of experience in SAAS development, We has worked with clients from various industries and has delivered successful SAAS solutions.At VT Foods Private Limited, we understand that every business has unique needs and requirements. Therefore, we work closely with our clients to understand their specific needs and design customized solutions that cater to their needs. Our focus on client satisfaction, coupled with our expertise in SAAS development, enables us to deliver high-quality solutions that exceed our clients' expectations.",
    "If you're looking for a reliable SAAS Application Development company that can deliver customized solutions to meet your specific needs, VT Foods Private Limited is the perfect partner for you. We pride ourselves on delivering solutions that are scalable, secure, and efficient, helping businesses of all sizes achieve their goals. Contact us today to learn more about our SAAS development services and how we can help you take your business to the next level."
  ],
    ...
    <Box >
      <Container maxWidth="xl">
        <Box  padding={"50px 0 0 0"}>
          <SideBySideSection data={ServerlessData} isFlip desc/>
        </Box>
      </Container>
    </Box>
  );
